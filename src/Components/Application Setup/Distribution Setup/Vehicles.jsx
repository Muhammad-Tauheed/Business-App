            ...
            <div className='h-full bg-white' >
                ...
                <div className='flex'>
                    ...
                    <div className='w-full px-8 max-2xl:ml-[250px] max-xl:ml-[100px] mt-[50px] overflow-x-hidden'>
                        <h1 className='text-3xl ml-5 mt-5'>Vehicle</h1>
                        <div>
                            <div className='flex w-100 justify-evenly py-1 mt-9'>
                                ...
                                <button
                                    ...
                                    className={`btn w-52 ${activeTab === 2 ? "bg-gray-600 hover:bg-gray-400 text-white" : "bg-gray-600 border shadow-lg hover:bg-gray-400 text-white"}`}
                                >
                                    New Vehicle & Driver
                                </button>
                            ...
                            {activeTab === 1 && <div><VehiclesDetail /></div>}
                            {activeTab === 2 && <div><NewVehicle/></div>}
                        </div>
                    </div>
                </div>
            </div>
