                        ...
                        <div>
                            <div className='flex w-100 justify-evenly py-1 mt-9'>
                                ...
                                <button
                                    ...
                                    className={`btn w-52 ${activeTab === 3 ? "bg-gray-600 hover:bg-gray-400 text-white" : "bg-gray-600 border shadow-lg hover:bg-gray-400 text-white"}`}
                                >
                                    Add New Country & City
                                </button>
                            ...
                            {activeTab === 1 && <div><CountryDetail/></div>}
                            {activeTab === 2 && <div><CityDetail/></div>}
                            {activeTab === 3 && <div><NewCountry/></div>}
                        </div>
                    </div>
                </div>
            </div>
