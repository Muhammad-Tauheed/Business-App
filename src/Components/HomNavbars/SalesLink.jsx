  ...
  return (
    ...
    <li className={`w-full`}>
                <details open={open1} className={`flex justify-evenly w-full `}>
                    <summary className={`px-10 text-xl font-semibold max-2xl:text-xl max-xl:text-[17px]  ${pathname === "/saleInvoice" || pathname === "/saleInvoice/1" || pathname === "/customers" || pathname === "/customers/1" || pathname === "/article" || pathname === "/editcustomer" || pathname === "/newarticles" ? "bg-zinc-700  hover:bg-zinc-800   font-semibold rounded-lg text-white " : ""}`}>
                        <FaMoneyBillAlt className="text-3xl" /> <span className='max-xl:hidden'>Sales</span>
                    </summary>
