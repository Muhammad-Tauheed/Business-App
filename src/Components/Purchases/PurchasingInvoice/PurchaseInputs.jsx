            ...
            <div className="overflow-x-auto">
                <table className="table">
                    ...
                    <tbody>
                        ...
                        {data.map((item, index) => (
                            <tr key={index}>
                                <td><input type="text" placeholder="Article" className="input input-bordered input-sm w-full max-w-xs" /></td>
                                <td><input type="text" placeholder="Item" className="input input-bordered input-sm w-40 max-w-xs" /></td>
                                <td><input type="text" placeholder="Q" className="input input-bordered input-sm w-full max-w-xs" /></td>
                                <td>{item.units}</td>
                                <td>
